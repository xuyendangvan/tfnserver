...
func SendToTopic(ctx context.Context, client *messaging.Client, topic string, title string, body string) {
	// [START send_to_topic_golang]
	// The topic name can be optionally prefixed with "/topics/".

	// See documentation on defining a message payload.
	message := allPlatformsMessage(topic, title, body)
...
func allPlatformsMessage(topic string, title string, body string) *messaging.Message {
